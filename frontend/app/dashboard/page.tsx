...
export default function DashboardPage() {
  ...
  return (
    <div className="bg-linear-to-br from-gray-50 to-gray-100 transition-colors duration-200">
      {/* Main content */}
      <div className="w-full">
        ...
        <main className="p-4 sm:p-6">
          <div className="mx-auto max-w-7xl w-full">
            {/* Welcome Banner */}
            <div className="rounded-2xl p-8 mb-8 bg-linear-to-r from-amber-500 to-[#B38600] text-white shadow-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <Card className="transform hover:scale-[1.02] transition-transform duration-200 bg-white border border-gray-200 shadow-lg hover:shadow-xl rounded-2xl overflow-hidden">
                <div className="bg-linear-to-r from-amber-500 to-amber-600 h-2"></div>
              ...
              <Card className="transform hover:scale-[1.02] transition-transform duration-200 bg-white border border-gray-200 shadow-lg hover:shadow-xl rounded-2xl overflow-hidden">
                <div className="bg-linear-to-r from-yellow-500 to-yellow-600 h-2"></div>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
              ...
              <Card className="transform hover:scale-[1.02] transition-transform duration-200 bg-white border border-gray-200 shadow-lg hover:shadow-xl rounded-2xl overflow-hidden">
                <div className="bg-linear-to-r from-red-500 to-red-600 h-2"></div>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
            ...
            <Card className="mb-8 bg-white border border-gray-200 shadow-lg rounded-2xl overflow-hidden">
              <div className="bg-linear-to-r from-[#B38600] to-purple-600 h-2"></div>
                ...
                <form onSubmit={handleAddTodo} className="flex flex-col gap-4">
                  <div className="w-full">
                    <Input
                      ...
                      className="w-full bg-white text-gray-900 border-gray-300 rounded-lg py-3 px-4 shadow-sm focus:ring-2 focus:ring-[#B38600] focus:border-transparent transition-all duration-200"
                      required
                    />
                    <Textarea
                      ...
                      className="w-full mt-3 bg-white text-gray-900 border-gray-300 rounded-lg py-3 px-4 shadow-sm focus:ring-2 focus:ring-[#B38600] focus:border-transparent transition-all duration-200"
                      rows={2}
                    />
                  </div>
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Select
                      ...
                      className="flex-1 bg-white text-gray-900 border-gray-300 rounded-lg py-2 px-3 shadow-sm focus:ring-2 focus:ring-[#B38600] focus:border-transparent transition-all duration-200"
                    >
                      <option value="low">Low Priority</option>
                      <option value="medium">Medium Priority</option>
                      <option value="high">High Priority</option>
                    </Select>
                    <Button type="submit" variant="primary" size="md" className="py-3 px-6 flex-1 min-w-35 font-semibold bg-linear-to-r from-[#B38600] to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200" disabled={isAddingTodo}>
            ...
            <Card className="bg-white border border-gray-200 shadow-lg rounded-2xl overflow-hidden">
              <div className="bg-linear-to-r from-gray-50 to-gray-100 h-2"></div>
              ...
              <CardContent className="my-5">
                {todos.length === 0 ? (
                  <div className="p-12 text-center rounded-xl bg-gray-50 border border-gray-200">
                    <div className="mx-auto w-16 h-16 rounded-full bg-linear-to-br from-amber-100 to-indigo-100 flex items-center justify-center mb-4">
                            ...
                            <div className="flex items-center space-x-3 mt-4">
                              ...
                              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${(todo.status || 'todo') === 'completed'
                                ...
                                <div className={`w-2 h-2 rounded-full mr-1.5 ${(todo.status || 'todo') === 'completed' ? 'bg-green-500' :
                                  (todo.status || 'todo') === 'in-progress' ? 'bg-amber-500' : 'bg-gray-500'
                                  }`}></div>
            ...
            <form onSubmit={handleUpdateTodo}>
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="bg-white text-gray-900 border-gray-300 rounded-lg py-3 px-4 shadow-sm focus:ring-2 focus:ring-[#B38600] focus:border-transparent transition-all duration-200"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      className="bg-white text-gray-900 border-gray-300 rounded-lg py-2 px-4 shadow-sm focus:ring-2 focus:ring-[#B38600] focus:border-transparent transition-all duration-200"
                    >
                      <option value="low">Low Priority</option>
                      <option value="medium">Medium Priority</option>
                      <option value="high">High Priority</option>
              ...
              <div className="flex space-x-3 mt-8">
                ...
                <Button
                  ...
                  variant="primary"
                  size="md"
                  className="py-3 px-6 flex-1 min-w-35 font-semibold bg-linear-to-r from-[#B38600] to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-md hover:shadow-lg"
          ...
          <Card className="w-full max-w-sm p-6 bg-white border border-gray-200 shadow-2xl rounded-2xl">
            ...
            <div className="flex space-x-3">
              ...
              <Button
                ...
                variant="destructive"
                size="md"
                className="py-3 px-6 flex-1 min-w-35 font-semibold bg-linear-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 shadow-md hover:shadow-lg"
