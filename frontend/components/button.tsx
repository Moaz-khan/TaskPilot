...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-amber-600 to-[#B38600] text-white hover:from-amber-700 hover:to-[#B38600] focus:ring-amber-500 active:scale-95',
    ...
    outline: 'border-2 border-amber-600 text-blue-700 hover:bg-blue-50 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white active:scale-95',
