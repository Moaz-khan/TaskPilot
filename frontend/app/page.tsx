    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-gray-100">
          ...
          <div className="flex justify-between items-center h-16">
            <Link href="/">
              <div className="flex items-center space-x-3">
                <div className="bg-linear-to-r from-amber-600 to-[#B38600] w-10 h-10 rounded-xl flex items-center justify-center shadow-lg">
                ...
                <span className="text-xl sm:text-2xl font-bold text-gray-900">TaskPilot</span>
              </div>
            </Link>
            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-gray-700 hover:text-amber-600 transition-colors font-medium">Features</a>
              <a href="#how-it-works" className="text-gray-700 hover:text-amber-600 transition-colors font-medium">How It Works</a>
            ...
            {/* Mobile menu button */}
            <button
              className="md:hidden text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-amber-500 p-2 rounded-lg"
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
            <div className="px-4 py-5 space-y-4">
              <a href="#features" className="block py-2 text-gray-700 hover:text-amber-600 font-medium">Features</a>
              <a href="#how-it-works" className="block py-2 text-gray-700 hover:text-amber-600 font-medium">How It Works</a>
              <a href="#benefits" className="block py-2 text-gray-700 hover:text-amber-600 font-medium">Benefits</a>
      ...
      <section className="py-16 sm:py-24 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center bg-linear-to-r from-amber-50 to-indigo-50 px-4 py-2 rounded-full text-sm font-medium mb-6 border border-amber-100">
            <span className="text-amber-600">✨ Productivity Redefined</span>
          </div>
          ...
          <p className="text-lg sm:text-xl hero-subheading mb-8 max-w-2xl mx-auto leading-relaxed">
            TaskPilot is a modern task management platform that helps you stay organized, focused, and productive. Built for professionals who demand excellence.
          </p>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="rounded-2xl bg-white border border-gray-200 p-2 shadow-lg">
              ...
              <div className="aspect-image rounded-xl overflow-hidden bg-gray-100">
                <Image
                  src="/maaz.png"
                  alt="TaskPilot Dashboard Preview"
                  width={1280}
                  height={720}
      ...
      <section id="features" className="py-20 px-4 bg-gray-50/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-amber-500/50 transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              <div className="w-12 h-12 bg-linear-to-r from-amber-500 to-[#B38600] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-amber-500/50 transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              <div className="w-12 h-12 bg-linear-to-r from-green-500 to-emerald-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-amber-500/50 transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              <div className="w-12 h-12 bg-linear-to-r from-purple-500 to-violet-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-amber-500/50 transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              <div className="w-12 h-12 bg-linear-to-r from-orange-500 to-red-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-amber-500/50 transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              <div className="w-12 h-12 bg-linear-to-r from-cyan-500 to-amber-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-amber-500/50 transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              <div className="w-12 h-12 bg-linear-to-r from-pink-500 to-rose-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                <div className="shrink-0 w-12 h-12 bg-linear-to-r from-amber-500 to-[#B38600] rounded-xl flex items-center justify-center font-bold text-white text-lg">
                  1
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="shrink-0 w-12 h-12 bg-linear-to-r from-green-500 to-emerald-600 rounded-xl flex items-center justify-center font-bold text-white text-lg">
                  2
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="shrink-0 w-12 h-12 bg-linear-to-r from-purple-500 to-violet-600 rounded-xl flex items-center justify-center font-bold text-white text-lg">
                  3
                </div>
                <div>
            ...
            <div className="rounded-2xl bg-gray-50 border border-gray-200 p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-3 rounded-xl bg-white border border-gray-200 shadow-sm">
                  ...
                  <span className="text-xs px-2 py-1 bg-amber-100 text-amber-800 rounded-full">High</span>
                </div>
      ...
      <section id="benefits" className="py-20 px-4 bg-gray-50/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="flex items-start space-x-4">
              <div className="shrink-0 w-12 h-12 rounded-xl flex items-center justify-center mt-1 bg-amber-100 text-amber-600">
            ...
            <div className="flex items-start space-x-4">
              <div className="shrink-0 w-12 h-12 rounded-xl flex items-center justify-center mt-1 bg-green-100 text-green-600">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
            ...
            <div className="flex items-start space-x-4">
              <div className="shrink-0 w-12 h-12 rounded-xl flex items-center justify-center mt-1 bg-purple-100 text-purple-600">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                </svg>
              </div>
            ...
            <div className="flex items-start space-x-4">
              <div className="shrink-0 w-12 h-12 rounded-xl flex items-center justify-center mt-1 bg-orange-100 text-orange-600">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" />
                </svg>
              </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-linear-to-r from-amber-600 to-indigo-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90! mb-8 max-w-2xl mx-auto">
            Join thousands of professionals who have streamlined their workflow with TaskPilot
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button
              ...
              variant="primary"
              size="lg"
              className="px-8 py-4 text-base font-semibold bg-white text-amber-600 hover:bg-gray-100"
            >
              {isAuthenticated ? 'Go to Dashboard' : 'Start Free Trial'}
            </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                <div className="bg-linear-to-r from-amber-600 to-[#B38600] w-8 h-8 rounded-lg flex items-center justify-center">
                ...
                <span className="text-lg font-bold text-gray-900">TaskPilot</span>
              </div>
              <p className="text-sm text-gray-600 mb-4">
                The modern task management platform for professionals who demand excellence.
              </p>
              <div className="flex space-x-4">
                <a href="https://github.com/Moaz-khan" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-amber-600 transition-colors">
                ...
                <a href="https://www.linkedin.com/in/m-maaz-602927243?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-amber-600 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
                  </svg>
                </a>
                <a href="https://x.com/muhammad_m93263" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-amber-600 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><a href="#" className="hover:text-amber-600 transition-colors">Features</a></li>
                <li><a href="#" className="hover:text-amber-600 transition-colors">Pricing</a></li>
                <li><a href="#" className="hover:text-amber-600 transition-colors">Security</a></li>
                <li><a href="#" className="hover:text-amber-600 transition-colors">Integrations</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li><a href="#" className="hover:text-amber-600 transition-colors">API</a></li>
                <li><a href="#" className="hover:text-amber-600 transition-colors">Status</a></li>
              </ul>
            </div>
          </div>
