...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-amber-50 via-white to-[#B38600] flex items-center justify-center p-4">
      <Card className="w-full max-w-md overflow-hidden">
        <CardHeader className="text-center pb-4">
          <div className="mx-auto bg-linear-to-r from-amber-600 to-[#B38600] w-16 h-16 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
            <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="4" y="6" width="24" height="20" rx="3" fill="white" fillOpacity="0.9" />
              <path d="M12 12H20M12 16H18M12 20H16" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className="pr-12 focus:ring-amber-500 focus:border-amber-500"
                />
      ...
      "
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-amber-700">
              ...
              <Link href="/auth/signup" className="text-amber-700 hover:text-amber-800 font-semibold hover:underline">
                Sign up for free
              </Link>
            </p>
          </div>
